...
## ℹ️ Fleet Radar 관련 삽질 — 제거됨 (2026-04-21)
> Fleet Radar 기능 전체 폐기. `/api/fleet` 500 에러, data.go.kr serviceKey 이중 인코딩 등 관련 삽질 기록은 아카이브(`docs/archived/PRD-fleet-radar.md`)와 git history에서 참조 가능.
