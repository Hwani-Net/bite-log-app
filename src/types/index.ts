...
// 기록 입력 어종. 예약 화면이 실제로 검색할 수 있는 어종(더피싱 si[] 26종)
// 보다 좁으면 "예약해서 잡고 왔는데 기록에 그 어종이 없다"가 된다 —
// 2026-08-28 사용자 지적. 더피싱 어종에 방파제·갯바위에서 흔한 어종
// (전갱이·학꽁치·쥐노래미 등)을 더한 목록이다. '기타'는 자유 입력 폴백.
