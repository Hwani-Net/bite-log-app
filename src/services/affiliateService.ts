  ...
  볼락: [
    {
      ...
      species: "볼락",
      category: "루어",
      name: "골든훅 볼락 지그헤드 전사이즈",
      description: "야간 볼락 루어 필수, 아징 지그헤드 세트",
      priceRange: "1~3만원",
        ...
        "https://shopping-phinf.pstatic.net/main_8415157/84151572662.jpg?type=f300" },
    {
      ...
      species: "볼락",
      category: "대",
      name: "워터맨 올드보이 볼락 루어대",
      description: "내만 방파제 락피쉬 전용 루어대",
      priceRange: "5~12만원",
...
const DEFAULT_GEAR: GearRecommendation[] = [
  {
    ...
    species: "공통",
    category: "소품",
    name: "손피싱 캐리어 멀티 태클박스",
    description: "모든 소품을 깔끔하게 정리",
    priceRange: "2~5만원",
      ...
      "https://shopping-phinf.pstatic.net/main_8556734/85567347909.jpg?type=f300" },
  {
    ...
    category: "의류",
    name: "방수 낚시 자켓",
    description: "비바람에도 끄떡없는 고어텍스급 방수",
    priceRange: "5~15만원",
      ...
      "https://shopping-phinf.pstatic.net/main_9050404/90504042024.1.jpg?type=f300" },
  {
    ...
    species: "공통",
    category: "안전",
    name: "알바트로스 자동팽창식 구명조끼",
    description: "선상낚시 필수 안전장비",
    priceRange: "5~10만원",
...
export function trackAffiliateClick(gearId: string, species: string): void {
  ...
  try {
    const clicks = JSON.parse(
      localStorage.getItem("fishlog_affiliate_clicks") || "[]",
    );
