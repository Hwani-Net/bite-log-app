...
// Source: 한국수산과학원 어류생태 자료 + 실전 낚시 경험치
const SPECIES_CONDITIONS: SpeciesCondition[] = [
  ...
  },
  {
    ...
    depthRange: '20~80m',
    note: '수온 16~22°C 구간이 최적. 새벽 매직아워에 집중하세요.',
  },
  {
    species: '우럭',
    emoji: '🪨',
    ...
    depthRange: '20~50m',
    note: '수온 변화에 둔감하고 연중 낚이지만, 찬물일 때 바닥층 공략이 효과적입니다.',
  },
  {
    species: '볼락',
    emoji: '🐡',
    ...
    pressureSensitivity: 'medium',
    depthRange: '5~20m',
    note: '야간 라이트 게임의 대표 어종. 조용한 밤, 약한 조류에서 슬로우 폴링이 핵심.',
  },
  {
    species: '광어',
    emoji: '🐠',
    ...
    pressureSensitivity: 'medium',
    depthRange: '5~30m',
    note: '바닥 공략 필수. 들물 시 모래 바닥 포인트로 이동하며 먹이활동이 활발해집니다.',
  },
  {
    species: '주꾸미',
    emoji: '🐙',
    ...
    pressureSensitivity: 'low',
    depthRange: '10~30m',
    note: '가을 시즌(9~11월)이 피크. 빨간 에기로 바닥 톡톡이 핵심 테크닉.',
  },
  {
    species: '농어',
    emoji: '🐈',
    ...
    pressureSensitivity: 'high',
    depthRange: '1~15m',
    note: '기압 하강 시 표층 활동 증가. 새벽/해질녘 톱워터에 폭발적으로 반응합니다.',
  },
  {
    species: '고등어',
    emoji: '🐟',
    ...
    pressureSensitivity: 'low',
    depthRange: '5~50m',
    note: '떼로 이동하며 수온이 적합하면 시간 무관하게 낚임. 카드채비가 효율적.',
  },
  {
    species: '쥐노래미',
    emoji: '🐟',
    ...
    pressureSensitivity: 'low',
    depthRange: '3~15m',
    note: '겨울 방파제 낚시의 주력 어종. 크릴 미끼로 바닥~중층 공략.',
  },
  {
    species: '방어',
    emoji: '🐟',
    ...
    pressureSensitivity: 'high',
    depthRange: '30~100m',
    note: '겨울 대물 시즌. 조류가 강할 때 지깅으로 공략. 기압 변화에 민감합니다.',
  },
];
