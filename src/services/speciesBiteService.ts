...
const SPECIES_CONDITIONS: SpeciesCondition[] = [
  ...
  },
  {
    ...
    seasonalActivity: {
      spring: [0.3, 0.2, 0.2, 0.35, 0.7, 0.9, 0.85, 0.65, 0.5, 0.4, 0.3, 0.2, 0.2, 0.2, 0.3, 0.4, 0.55, 0.75, 0.85, 0.6, 0.4, 0.3, 0.3, 0.3],
      summer: [0.25, 0.2, 0.15, 0.25, 0.6, 0.8, 0.75, 0.6, 0.4, 0.3, 0.2, 0.15, 0.15, 0.15, 0.2, 0.3, 0.45, 0.6, 0.7, 0.5, 0.35, 0.25, 0.25, 0.25],
      autumn: [0.35, 0.3, 0.25, 0.4, 0.75, 0.95, 0.9, 0.7, 0.55, 0.4, 0.3, 0.25, 0.25, 0.25, 0.3, 0.5, 0.65, 0.80, 0.90, 0.65, 0.5, 0.4, 0.35, 0.35],
