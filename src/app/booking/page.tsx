  ...
  return (
    <div className="min-h-screen bg-bg dark:bg-bg-dark page-enter">
      ...
      <div className="bg-gradient-to-br from-primary/10 via-cyan-500/5 to-transparent px-5 pt-6 pb-8">
        <Link
          href="/"
          className="inline-flex items-center gap-1 text-sm text-slate-500 mb-4 hover:text-primary transition-colors"
        >
          <ArrowLeft size={14} />
          홈으로
        </Link>
      ...
      <div className="max-w-lg mx-auto px-4 -mt-4 space-y-4 pb-24">
        {PLATFORMS.map((platform, i) => (
          <a
            ...
            className="block bg-white dark:bg-surface-dark rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50 overflow-hidden hover:shadow-md hover:scale-[1.01] transition-all duration-200"
