...
export default function PaywallBottomSheet() {
  const { isPaywallOpen, paywallFeature, closePaywall, isPro } =
          ...
          <div className="bg-slate-50 rounded-2xl p-4 w-full border border-slate-100">
            <ul className="space-y-3 text-left">
              {[
                ...
                {
                  icon: "location_on",
                  text: "지역별 시크릿 배스 포인트 무제한 열람" },
                {
                  icon: "notifications_active",
                  text: "실시간 카카오톡 오픈런 알림 10개 (무료 1개)" },
              ].map((item, i) => (
